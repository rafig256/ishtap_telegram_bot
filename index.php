...
const REQUEST_JOIN_MESSAGE = 'شما عضو کانال ' . CHANEL_ID . " نیستید. ممنون می شویم اگر عضو شوید. البته به هیچ وجه اجباری نیست!";
const LAW = "<b>🖤 شرایط شرکت در طرح جمعه سیاه:</b>\n\n" .
    "1️⃣ شما باید پیج اینستاگرامی با بیش از ".MINIMUM_FOLLOWERS." نفر دنبال‌کننده داشته باشید. " .
    "\n\n" .
    "2️⃣ دفتر فیزیکی یا شماره ی پاسخگو داشته باشید.\n\n" .
...
const PROCESS = "<b>📋 مراحل کار:</b>\n\n" .
    ...
    "4️⃣ پس از اینکه وارد سایت شدید، شغل خود را <a href='https://ishtap.ir/user/listing/create' target='_blank'>ثبت کرده</a> و با کد تخفیف پرداخت کنید. (هزینه با کد تخفیف بین <b>180 تا 900 هزار تومان</b> خواهد بود.)\n\n".
    ...
    "هزینه پرداختی عودت داده شده و صفحه شما تا پایان یکسال در سایت باقی خواهد ماند. برای اینکه از گارانتی استفاده کنید حتما بعد از ثبت شغل به پیشتیبان اطلاع بدید تا خودش صفحتون رو به رایگان سئو کنه!";
...
const LAW_MENU = array(
    ...
    'inline_keyboard' => array(
        ...
        array(
            array('text' => 'دریافت کد تخفیف '.DISCOUNT_PERCENT.' درصدی', 'callback_data' => 'get_discount')
        ),
        array(
